...
export default function ApplicationPage() {
  ...
  const [setLanguage, setSetLanguage] = useState(() => (newLanguage: string) => {}); // Declare setLanguage variable
        ...
        <nav className="fixed top-0 left-0 right-0 z-30 bg-black/20 backdrop-blur-sm transition-all duration-300">
          <div className="container mx-auto px-4 py-6 md:py-8">
            <div className="flex items-center justify-between">
              <SharedHeader language={language} setLanguage={setSetLanguage} headerLogoOpacity={headerLogoOpacity} />
            </div>
          </div>
        </nav>
