...
${formData.message || "None"}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-100 via-emerald-50 to-amber-50">
      {/* Navigation */}
      <nav className="sticky top-0 z-30 bg-teal-800/95 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center space-x-3">
              ...
              />
              <span className="hidden md:block text-white font-semibold">Pacífico Internacional</span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/#admissions" className="text-white hover:text-yellow-200 transition-colors">
                {t("admissions")}
              </Link>
