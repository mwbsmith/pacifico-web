        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300">{text[language].footerDescription}</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4 text-white">{text[language].quickLinks}</h4>
              <ul className="space-y-2">
                ...
                <li>
                  ...
                  >
                    {text[language].familyHandbook}
                  </a>
                </li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4 text-white">{text[language].connectWithUs}</h4>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              &copy; {new Date().getFullYear()} {text[language].footerCopyright}
            </p>
          </div>
        </div>
      </footer>
