...
const translations = {
  en: {
    ...
    description: "A member of our admissions team will contact you within 24 hours to discuss how Pacífico Internacional can be the perfect fit for your family's relocation to Costa Rica.",
    whatNext: "What happens next?",
    step1: "Our team will review your inquiry",
    step2: "We'll reach out to schedule a call or video tour",
    step3: "Learn about our programs and visit our campus",
  ...
  es: {
    ...
    description: "Un miembro de nuestro equipo de admisiones te contactará dentro de 24 horas para discutir cómo Pacífico Internacional puede ser la opción perfecta para la reubicación de tu familia a Costa Rica.",
    whatNext: "¿Qué sigue?",
    step1: "Nuestro equipo revisará tu consulta",
    step2: "Te contactaremos para programar una llamada o tour virtual",
    step3: "Conoce nuestros programas y visita nuestro campus",
...
export default function InternationalFamiliesThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined" && typeof (window as any).gtag === "function") {
      ...
      const conversionLabel = process.env.NEXT_PUBLIC_GOOGLE_ADS_INTERNATIONAL_CONVERSION_LABEL
