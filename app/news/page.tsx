...
// News articles loaded from data file
          ...
          {newsArticles.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {newsArticles.map((article) => (
                <Card key={article.slug} className="bg-white border-2 border-teal-100 hover:shadow-lg transition-shadow overflow-hidden">
